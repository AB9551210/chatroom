...
import com.example.test.databinding.ActivityUsersBinding;
import com.example.test.listeners.UserListener;
...
public class UsersActivity extends BaseActivity implements UserListener {
    ...
    private void showErrorMessage(){
        binding.textErrorMessage.setText(String.format("%s","无其它账户存在"));
